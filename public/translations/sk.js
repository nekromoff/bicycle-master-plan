translation = {
    "values": {
        ...
        "From my location": "Z aktuálnej polohy",
        "Locating…": "Zisťujem polohu…",
        "Location access was denied": "Prístup k polohe bol zamietnutý",
        ...
        "End navigation": "Zavrieť navigáciu",
        ...
        "Start navigation": "Spustiť navigáciu",
        "Stop": "Zastaviť",
        "Mute": "Stlmiť",
        "Unmute": "Zapnúť zvuk",
        "Recentre": "Vycentrovať",
        "km/h": "km/h",
        "Waiting for the location…": "Čaká sa na polohu…",
        "Location is not available": "Poloha nie je dostupná",
        "Off the route": "Mimo trasy",
        "then": "potom",
        // spoken
        "Straight": "Rovno",
        "Slightly right": "Mierne doprava",
        "Right": "Doprava",
        "Slightly left": "Mierne doľava",
        "Left": "Doľava",
        "%{manoeuvre} onto %{street}": "%{manoeuvre} na %{street}",
        "%{manoeuvre} in %{distance}": "%{manoeuvre} o %{distance}",
        "Roundabout, exit %{exit}": "Kruhový objazd, %{exit}. výjazd",
        "Cross the road": "Prejdite cez cestu",
        "Without a path": "Bez cyklotrasy",
        "Destination": "Cieľ",
        "You have arrived at the destination": "Ste v cieli",
        "Mind the tracks": "Pozor, koľaje",
        "Route recalculated": "Trasa bola prepočítaná",
        "Return to the route": "Vráťte sa na trasu",
        "%n metres": [[1, 1, "%n meter"], [2, 4, "%n metre"], [5, null, "%n metrov"]],
        "%n kilometres": [[1, 1, "%n kilometer"], [2, 4, "%n kilometre"], [5, null, "%n kilometrov"]],
        "%{n} kilometres": "%{n} kilometra",
        // administration
        "Zoom in": "Priblížiť",
        "Zoom out": "Oddialiť",
